library stepper_form;

import 'package:flutter/material.dart';

class CustomStepperForm extends StatefulWidget {
  final List<Widget> pages;
  final List<CustomStepperFormTitle> titles;
  final CustomStepperFormController controller;
  final double height;
...
class CustomStepperFormTitle extends StatelessWidget {
  String title, subTitle;
  Color activeColor;
  CustomStepperFormTitle(
      {this.activeColor, this.subTitle, @required this.title});
  @override
  Widget build(BuildContext context) {
...
class CustomStepperFormController extends ChangeNotifier {
  CustomStepperFormController(this.length);
  int _page = -1;
  final int length;
